...
var counter = restaurants.length;
...
var root = {
  restaurant: (arg) => {
    return restaurants[restaurants.findIndex(restaurant => restaurant.id == arg.id)] 
  },
  restaurants: () => {
    return restaurants;
  },
  ...
  editrestaurant: ({ id, ...restaurant }) => {
    if(!restaurants.findIndex(restaurant => restaurant.id == id)){
